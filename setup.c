 ...
 */
void setupI2C() {
	P4SEL |= (BIT1 + BIT2);                 // Assign I2C pins to USCI_B0 (P4.1 -> SDA / P4.2 -> SCL)
	//P3REN |= (BIT0 + BIT1);
	...
	UCB1BR0 = (unsigned char)((F_CPU / I2C_FREQ) & 0xFF);
	UCB1BR1 = (unsigned char)((F_CPU / I2C_FREQ) >> 8);
...
/*
 * Configuracao para o funcionamento do SPI
 * P3.2 - SCLK
 * P3.0 - MISO
 * P3.1 - MOSI
 */
